  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (err.message && err.message.includes("banned")) {
         setError("Your account has been banned. If you believe this is an error, please contact Vaulty Group Support.");
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="space-y-3">
             ...
             <button 
               onClick={handleLogin}
               disabled={loading}
               className="w-full py-4 bg-white text-black font-bold rounded-full hover:bg-gray-200 transition-all active:scale-95 disabled:opacity-70"
             >
        ...
        <div className="space-y-4 text-center">
          <p className="text-gray-500 text-xs">
            By clicking on Sign In, you agree with our <span className="text-white font-semibold">Terms of Service</span>
          </p>
          <p className="text-center text-gray-500 text-sm">
            Don't have an account? <Link href="/register" className="text-white font-bold cursor-pointer hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
